...
class IMDBFetcher(): #make a cache folder to load url quickly instead of hitting api everytime
    ...
    def generate_link(self, titleid: str) -> str:
        ...
        return self._validate_imdb_url(f"{self.base_link}/title/{titleid}/{self.ref}")
...
class OMDBClient():
    ...
    def fetch_movie(self, movie_name, mycategory) -> Optional[Movie]:
        ...
        if data.get("Response") == "True":
            return Movie(
                ...
                imdblink = imdb_obj.generate_link(data.get("imdbID","N/A")),
            )
